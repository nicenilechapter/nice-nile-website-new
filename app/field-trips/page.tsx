...
export default async function ConferencesPage(){
    ...
    const listOfBlobs = await list({
      //   cursor,
      limit: 1000,
      prefix: "julius-berger-excursion/",
    });
    ...
    return (
      <main className="min-h-screen">
        ...
        <h1 className="text-3xl font-semibold text-center mt-3">Field Trips</h1>

        {/* Should have put this in a component but oh well */}
        <section className="px-4 pt-3">
          <h2 className="text-xl font-semibold">Excursion to Julius Berger</h2>
            ...
            {listOfBlobs.blobs.map((file, i) => (
              ...
              >
                <Image
                  ...
                  alt={file.pathname}
                  fill
                  className="w-full md:w-auto min-h-full object-cover rounded-md"
                  loading="lazy"
                />
              </div>
            ))}
